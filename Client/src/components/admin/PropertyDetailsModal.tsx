...
//               <p className="text-gray-800">Is Rent Negotiable: {property.isNegotiable ? 'Yes' : 'No'}</p>
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-white w-full md:w-3/4 lg:w-2/3 h-3/4 rounded-lg overflow-auto shadow-lg">
        ...
        <div className="p-6 space-y-6">
          <h3 className="text-3xl font-bold mb-4">Property Type: {property.propertyType}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {property.isForSale && (
              <div>
                <h4 className="text-xl font-semibold">Sale Details</h4>
                <p className="text-gray-800">Sale Price: ${property.salePrice}</p>
                <p className="text-gray-800">Is Price Negotiable: {property.isPriceNegotiable ? 'Yes' : 'No'}</p>
              </div>
            )}
