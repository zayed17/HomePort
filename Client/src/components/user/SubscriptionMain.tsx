...
//     try {
//       const { data: { id: sessionId } } = await axios.post('http://localhost:5003/subscription/payment-intent', {
...
const SubscriptionHero: React.FC = () => {
  ...
  //   try {
  //     const { data: { sessionId } } = await axios.post('http://localhost:5002/subscriptions/payment-intent', {
  //       amount: selectedPlan.price * 100, 
  //       planId: selectedPlan._id,
  //       subscriptionType: selectedPlan.type,
  //       durationInDays: selectedPlan.durationInDays,
