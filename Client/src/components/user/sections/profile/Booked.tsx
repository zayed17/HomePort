    ...
    <div className="p-6 min-h-screen">
      {data?.properties?.length > 0 ? (
                      ...
                      {booking.propertyId.rentAmount !== 0 && (
                        <>
                          ...
                          <div className="flex items-center">
                            ...
                            <span className="text-sm font-semibold text-red-600 ml-1">₹{Number(
                              booking.propertyId.depositAmount - booking.amountPaid + 5000
                            ).toLocaleString()}</span>
                          </div>
                          <div className="flex items-center">
                      ...
                      {booking.propertyId.sellPrice !== 0 && (
                        <>
                          ...
                          <div className="flex items-center">
                            <span className="text-sm font-semibold">Balance Amount: </span>
                            <span className="text-sm font-semibold text-red-600 ml-1">₹{Number(
                              booking.propertyId.sellPrice - booking.amountPaid + 5000
                            ).toLocaleString()}</span>
                          </div>
                        </>
                      )}
        ...
        <div className="text-center text-gray-500 mt-20">
          <p className="text-lg font-medium">No Booked Properties Found</p>
          <p className="text-sm">Please check back later or make a booking to see it here.</p>
        </div>
      )}
    </div>
  );
