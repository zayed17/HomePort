...
import upload from '../routes/../express/middleware/uploadMiddleware'
...
const userController = new UserController(signUpUseCase, loginUseCase, otpVerificationUseCase,getUserDetailUseCase,updateUseCase,uploadImageUseCase,resendOTPUseCase,googleAuthUseCase);
...
router.post('/updateUser',authenticateToken('user'),(req,res,next)=>userController.updateUser(req,res,next));
